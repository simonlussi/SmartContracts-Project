...
// Functions
async function getData(owner: typeof mongoose.Schema.Types.EtherAddress, spender: typeof mongoose.Schema.Types.EtherAddress): Promise<mongoose.Document<unknown, any, Data> & Data & { _id: mongoose.Types.ObjectId; } & DataMethods | null> {
...
async function updateAllowance(owner: typeof mongoose.Schema.Types.EtherAddress, spender: typeof mongoose.Schema.Types.EtherAddress, amount: BigNumber): Promise<void> {
...
router.get(
  ...
  async (req: express.Request, res: express.Response): Promise<void | express.Response> => {
    ...
    const allowance = await getData(owner as unknown as typeof mongoose.Schema.Types.EtherAddress, spender as unknown as typeof mongoose.Schema.Types.EtherAddress);
