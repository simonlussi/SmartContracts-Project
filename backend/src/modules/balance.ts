...
// Functions
async function getData(owner: typeof mongoose.Schema.Types.EtherAddress): Promise<mongoose.Document<unknown, any, Data> & Data & { _id: mongoose.Types.ObjectId; } & DataMethods | null> {
